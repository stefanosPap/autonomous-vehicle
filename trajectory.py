...
def generate_random_trajectory(world, start_waypoint):
    ...
    for i in range(100):
        ...
        world.debug.draw_string(rand.transform.location, '{}'.format(i), draw_shadow=False, color=carla.Color(r=0, g=0, b=255), life_time=0, persistent_lines=True)
