...
def metrics(data_file):
    ...
    for route in routes:
        ...
        first_part = route.replace(",", " ").split()[0:2]   # The first two elements contain route_completion and off_road_event_time accordingly
        second_part = route.replace(",", " ").split()[2:]   # The last elements are the defined penalties 
